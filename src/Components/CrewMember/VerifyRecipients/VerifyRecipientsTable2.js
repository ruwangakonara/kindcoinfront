                    ...
                    {filterRecipients.map(recipient => (
                        <tr key={recipient._id}>
                            ...
                            <td>
                                <img
                                    // key={imgKey}
                                    src={recipient.documents[0]}
                                    alt="one"
                                    style={{maxWidth: '50px', cursor: 'pointer', marginRight: '5px'}}
                                    onClick={() => openModal(recipient.documents[0])}
                                />
                                <img
                                    // key={imgKey}
                                    src={recipient.documents[1]}
                                    alt="one"
                                    style={{maxWidth: '50px', cursor: 'pointer', marginRight: '5px'}}
                                    onClick={() => openModal(recipient.documents[1])}
                                />
                                <img
                                    // key={imgKey}
                                    src={recipient.documents[2]}
                                    alt="one"
                                    style={{maxWidth: '50px', cursor: 'pointer', marginRight: '5px'}}
                                    onClick={() => openModal(recipient.documents[2])}
                                />
                            </td>
                            <td>
                                <img
                                    // key={imgKey}
                                    src={recipient.certificate}
                                    alt="one"
                                    style={{maxWidth: '50px', cursor: 'pointer', marginRight: '5px'}}
                                    onClick={() => openModal(recipient.certificateVerifyRequestsTable.js)}
                                />
                            </td>
                                <td>
                                    <select
