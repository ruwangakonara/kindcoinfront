...
import classes from "../RegisterCrewMember/ViewCrewMembers.module.css";
...
const AssignCrewMemberPg = () => {
        ...
        const getDonations = async () => {
            try {
                const response = await axiosInstance.post('/admin/get_donations_for_assign', {type: "goods", verified: false, accepted: true});
    ...
    return (
        <div className={classes.mainContainer}>
            ...
            <DefaultDashCmp>
                ...
                <CrewMemberToDonationsTable donations={donations} members={members} axiosInstance={axiosInstance} getdonations={getDonations}/>
            </DefaultDashCmp>
        </div>
    );
}
