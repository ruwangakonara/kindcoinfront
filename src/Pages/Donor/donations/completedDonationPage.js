...
const dummyDonation = {
  ...
  donationDescription:
    "This is a donation for winter clothes including jackets, sweaters, and gloves.",
  goodsList: [
  ...
  requestDescription:
    "We are in need of winter clothes for the upcoming cold season. Your help will be greatly appreciated.",
...
function CompletedDonationPage() {
  ...
  const get_donation = async () => {
    try {
      const response = await axiosInstance.post("/donor/get_donation", {
        rewarded: true,
        _id: donation_id,
      });
  ...
  return (
    <div>
      ...
      <Grid>
        ...
        <Grid.Column width={15}>
          <Container className="donation-page-container">
                  ...
                  <Grid.Column width={8} textAlign="center">
                    <Image
                      src={
                        donor.profile_image !==
                        "https://via.placeholder.com/150"
                          ? "http://localhost:9013/images/profileimages/donor/" +
                            donor.profile_image
                          : "https://via.placeholder.com/150"
                      }
                      circular
                    ...
                    />
                    <Header as="h3" className="image-label">
                      Donor: {donor.name}
                    </Header>
                  </Grid.Column>
                  <Grid.Column width={8} textAlign="center">
                    <Image
                      src={
                        ...
                        "https://via.placeholder.com/150"
                          ? "http://localhost:9013/images/profileimages/beneficiary/" +
                            beneficiary?.profile_image
                          : "https://via.placeholder.com/150"
                      }
                      circular
                    ...
                    <Header as="h3" className="image-label">
                      Recipient:{" "}
                      <a
                        href={`http://localhost:3000/donor/beneficiaries/${beneficiary?._id}`}
                      >
                        {beneficiary?.name}
                      </a>
                    </Header>
                  ...
                  <Grid.Column width={16}>
                    <List className="donation-details">
                      ...
                      <List.Item>
                        ...
                        {request.open ? (
                          <a
                            href={`http://localhost:3000/donor/open-requests/${request?._id}`}
                          >
                            {request?.title}
                          </a>
                        ) : (
                          <a
                            href={`http://localhost:3000/donor/closed-requests/${request?._id}`}
                          >
                            {request?.title}
                          </a>
                        )}
                      ...
                      <List.Item>
                        ...
                        {String(donation.created).slice(0, 10) +
                          " @ " +
                          String(donation.created).slice(11, 16)}
                      </List.Item>
                    </List>
                  </Grid.Column>
                </Grid.Row>
                          ...
                          <Grid.Column width={8} textAlign="center">
                            <Image
                              src={
                                ...
                                "https://via.placeholder.com/150"
                                  ? "http://localhost:9013/images/profileimages/member/" +
                                    member.profile_image
                                  : "https://via.placeholder.com/150"
                              }
                              circular
                      ...
                      <>
                        {editingDocTransacId ? (
                          <Form>
                            ...
                            <Button
                              color="blue"
                              onClick={handleSaveDocTransacId}
                            >
                              Save
                            </Button>
                            <Button
                              color="grey"
                              onClick={() => setEditingDocTransacId(false)}
                            >
                              Cancel
                            </Button>
                          </Form>
                          ...
                          <Button
                            color="blue"
                            onClick={handleUpdateDocTransacId}
                          >
            ...
            <Segment>
              <Grid>
                <Grid.Row>
                  ...
                  {donation.doc_verified ? (
                    <h4 style={{ marginBottom: "10px", marginLeft: "12px" }}>
                      Attestation Fee{" "}
                      <Label
                        style={{ marginTop: "10px" }}
                        color="green"
            ...
            {donation.doc_verified && (
              <Button color="blue" onClick={handleAttestationModalOpen}>
                Show Attestation
              </Button>
            )}
            ...
            <Segment>
              <Grid>
                ...
                <Grid.Row>
                  ...
                  >
                    updated:{" "}
                    {String(donation.edited).slice(0, 10) +
                      " @ " +
                      String(donation.edited).slice(11, 16)}
                  </Header>
                </Grid.Row>
                {/*<Grid.Row>*/}
                ...
                <Grid.Row>
                  <Header style={{ marginLeft: "10px", marginTop: "10px" }}>
                    Your Satisfaction with Donation Usage
                  </Header>
                </Grid.Row>
      ...
      <Modal open={iSatisModalOpen} onClose={() => setIssatisModalOpen(false)}>
        <Modal.Header>
          Are you satisfied with the evident use of your contribution?
        </Modal.Header>
        <Modal.Content>
          <Form>
            <Checkbox
      ...
      >
        ...
        <Modal.Content>
          ...
          >
            ...
            <p>
              We hereby attest that the following donation has been received:
            </p>
        ...
        <Modal.Actions>
          <Button color="blue" onClick={safePrint}>
            Print Attestation
          </Button>
          <Button color="grey" onClick={handleAttestationModalClose}>
            Close
          </Button>
        </Modal.Actions>
      </Modal>
